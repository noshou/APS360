...
DISPLAY_NAMES = {
    ...
    "COD_68580": (
        "Au<sup>I</sup><sub>6</sub>Ag<sup>I</sup><sub>3</sub>"
        "Cu<sup>II</sup><sub>3</sub> Dodecanuclear Complex"
    ),
    ...
    "hydration_shells_graphite_tip3p_n17": (
        "Graphite Hydration Shell (TIP3P, n=17)"
    ),
...
CITATIONS = {
    ...
    "C60BuckyBallHe": (
        "https://doi.org/10.1038/ncomms2574",
        "Bloodworth et al., Nat. Commun. 5, 3442 (2014)",
    ),
    ...
    "NeonMOF": (
        "https://doi.org/10.1039/C6CC04808K",
        "Tu et al., Chem. Commun. 52, 9307 (2016)",
    ),
    "RhccCarborane": ("https://www.wwpdb.org/pdb?id=pdb_00007r6h", "PDB 7R6H"),
    "core_PURSEC": (
        "https://zenodo.org/records/3677685",
        "Chung et al., Chem. Mater. 31, 5535 (2019)",
    ),
    "core_RIVDIL": (
        "https://zenodo.org/records/3677685",
        "Chung et al., Chem. Mater. 31, 5535 (2019)",
    ...
    "hydration_shells_graphite_tip3p_n17": (
        ...
        "Gonzalez et al., J. Phys. Chem. C 112, 16497 (2008)",
    ),
    "qmof_qmof_1cf625b": (
        "https://doi.org/10.1039/b917258k",
        "QMOF Database v18 (Rosen et al., Matter 4, 1578 (2021))",
    ),
    "qmof_qmof_22103d2": (
        "https://doi.org/10.1039/C7DT03625F",
        "QMOF Database v18 (Rosen et al., Matter 4, 1578 (2021))",
    ),
}
