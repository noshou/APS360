...
module F0Factor
    ...
    real(c_double), parameter :: f0Data(26,26) = reshape([ &
            28.000000_c_double, &
            28.000000_c_double, &
            10.000000_c_double, &
            34.000000_c_double, &
...
contains
    ...
    function getF0(q, element) result(f0Val)
            ...
            ! Round q to nearest 0.02 Å⁻¹ grid point
            qRound = nint(q * 50.0_c_double) / 50.0_c_double
