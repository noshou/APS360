...
| `grad_clip`         | 2000.0  | Max gradient L2 norm before clipping. Raised from 1.0 after measuring pre-clip norms of 400-2000+ (p99) on a live run: at 1.0, clipping was firing on 100% of batches, acting as a constant unit-norm rescale rather than an occasional safety valve.                                                                                                                                                                                                    |
