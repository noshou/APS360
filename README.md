...
| `smoothing_lr_cut_trigger` | 2 | LR cuts (no escape) before delayed smoothing switches on; same count again post-smoothing means fully converged. See "Delayed smoothing + auto-kill" below.                                                                                                                                                                                                                    |
