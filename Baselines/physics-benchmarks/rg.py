...
def _guinier_stats(
    batch:  Batch,
    ftable: Float[torch.Tensor, "V Q"],
) -> tuple[Float[torch.Tensor, "N 1"], Float[torch.Tensor, "N 1"]]:
    """Per-molecule radius of gyration squared and I(0), shared by Rg baselines.
